package com.movile.quickbuck.queueapp.database.manual.provider;
...
import com.movile.quickbuck.queueapp.database.manual.helper.ProviderUriHelper;
import com.movile.quickbuck.queueapp.database.manual.helper.QueueDbHelper;


public class QueueTrackerContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        mDbHelper = new QueueDbHelper(getContext());
