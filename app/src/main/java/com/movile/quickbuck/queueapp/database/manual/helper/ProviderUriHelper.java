...
public class ProviderUriHelper {
    ...
    public ProviderUriHelper(Context context) {
        mAuthority = "com.movile..quickbuck.queueapp";

        mUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        mUriMatcher.addURI(mAuthority, UserEntity.FavoriteEntityFields.TABLE_NAME, CODE_FAVORITE_MANY);
        mUriMatcher.addURI(mAuthority, UserEntity.FavoriteEntityFields.TABLE_NAME + SINGLE_PATH_SUFFIX, CODE_FAVORITE_SINGLE);
    }
